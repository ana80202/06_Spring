...
//-rollbackFor 속성 : 어떤 예외가 발생했을 떄 rollback 할 지 지정
//------------------------------------------

//rollbackFor = Exception.class : 모든 종류의 예외 발생 시 rollback 수행해라!
@Transactional(rollbackFor = Exception.class)
@Service // 비즈니스 로직 처리해주는 거 // (데이터 가공, 트랜잭션 처리하는 것을 비즈니스 로직이라고 함)역할 명시 + Bean 등록
