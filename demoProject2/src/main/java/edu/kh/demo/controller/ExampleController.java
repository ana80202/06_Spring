...
public class ExampleController {
	...
	@GetMapping("ex1")
	public String ex1(HttpServletRequest req, Model model) { // model import 할떄 확인잘하기!!
	...
	public String ex2(Model model) {
		...
		model.addAttribute("str", "<h1>테스트 중 &times; </h1>"); // &times; -> 화면 상에 x로 나옴
	...
	public String ex5(Model model) {
		...
		// 기본적으로 request scope + session으로도 확장 가능
